...
- 🎨 **18 套原创预设主题**，每套完整覆盖全部 14 状态（内置烘焙 PNG）：6 套配色（极光 / 蜜糖 / 薄荷 / 晚霞 / 石墨 / 高对比）+ 12 套创意主题——猫爪 🐾、能量充能 ⚡、霓虹夜城 🌃、表情包 😀、像素 8-bit 👾、天气 ⛅、折纸 📐、太空人 🧑🚀、糖果玻璃 🍬、幽灵小镇 👻、高可见放大 🔍（48px）、波普圆点 🎈；每套主题还可一键下载为 ZIP 图片包
