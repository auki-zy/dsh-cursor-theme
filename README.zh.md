...
> 状态：**M8 完成**（创意预设主题 / 应用到系统 / 图片包）。需求文档见 [docs/requirements.md](docs/requirements.md)，可行性分析见 [docs/feasibility.md](docs/feasibility.md)。

## 功能

- 🎯 按 UI 状态独立配置光标图案（default / pointer / text / wait / not-allowed / grab / …）
- 🖼️ 内置 SVG 模板库（25 个形状）+ 上传 PNG/CUR（≤128×128、≤512KB 校验）
- 🎨 **19 套原创预设主题**，每套完整覆盖全部 14 状态（内置烘焙 PNG）：6 套配色（极光 / 蜜糖 / 薄荷 / 晚霞 / 石墨 / 高对比）+ 13 套创意主题——猫爪 🐾、能量充能 ⚡、霓虹夜城 🌃、表情包 😀、像素 8-bit 👾、天气 ⛅、折纸 📐、太空人 🧑🚀、糖果玻璃 🍬、幽灵小镇 👻、高可见放大 🔍（48px）、波普圆点 🎈、牛来 🐮；每套主题还可一键下载为 ZIP 图片包
