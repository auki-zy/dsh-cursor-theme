...
export const zh = {
  ...
  close: '关闭',
  upload: '上传图案',
  uploadHint: 'PNG（推荐）或 CUR，不超过 128×128、5 MB',
  builtin: '内置素材',
  builtinFor: '当前状态可选素材',
  removeImage: '移除图案',
  hotspot: '热区（点击点）',
  ...
  hotspotClickHint: '点击左侧图片可设置热区（点击点），或用上方数值微调',
  fallback: '兜底光标',
  resetAll: '恢复系统默认',
  resetAllHint: '清空全部状态配置，并同步还原系统光标（若之前已应用到系统）',
  resetAllRestoring: '正在还原系统光标…',
  resetAllApplied: '已恢复系统默认，系统光标已同步还原',
  resetAllFailed: '已恢复应用内默认，但系统光标还原失败',
  sysTitle: '应用到系统',
  ...
  import: '导入',
  importFailed: '导入失败',
  packDropHint: '点击选择 ZIP，或拖拽 ZIP 到此处导入',
  packDropSub: 'ZIP 内含各状态 PNG + manifest.json，单张 ≤ 5 MB',
  packImported: '已导入并应用',
  packScaled: '以下状态图片超过 128×128，已自动缩放：',
...
export const en: Record<string, string> = {
  ...
  close: 'Close',
  upload: 'Upload image',
  uploadHint: 'PNG (recommended) or CUR, max 128×128, 5 MB',
  ...
  hotspotClickHint: 'Click the image to set the hotspot (click point), or fine-tune with the numbers above',
  fallback: 'Fallback cursor',
  resetAll: 'Restore system default',
  resetAllHint: 'Clear every state override and revert system cursors too (if previously applied)',
  resetAllRestoring: 'Reverting system cursors…',
  resetAllApplied: 'Restored to system default; system cursors reverted too',
  resetAllFailed: 'App defaults restored, but reverting system cursors failed',
  ...
  packDropHint: 'Click to pick a ZIP, or drag & drop one here to import',
  packDropSub: 'A ZIP of state PNGs + manifest.json; each image ≤ 5 MB',
  packImported: 'Imported and applied',
  packScaled: 'these state images exceeded 128×128 and were auto-scaled:',
