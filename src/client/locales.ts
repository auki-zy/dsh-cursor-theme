...
export const zh = {
  ...
  sysMacHint: 'macOS 没有原生 API 替换系统光标——可以打开辅助功能设置引导授权，并把主题导出为 .cur 图片目录供第三方工具导入。',
  sysUnsupported: '当前系统暂不支持系统级光标应用。',
  sysApply: '应用到系统',
  sysWorking: '应用中…',
  sysRestore: '恢复系统默认',
  sysApplied: '已应用',
  sysRestored: '已恢复系统默认光标',
  sysFailed: '系统应用失败',
...
export const en: Record<string, string> = {
  ...
  sysMacHint: 'macOS has no native API to replace the system cursor — we can guide accessibility permission and export .cur files for third-party tools.',
  sysUnsupported: 'System-level cursors are not supported on this OS.',
  sysApply: 'Apply to system',
  sysWorking: 'Applying…',
  sysRestore: 'Restore defaults',
  sysApplied: 'Applied',
  sysRestored: 'System cursors restored to defaults',
