...
export const zh = {
  ...
  themeHint: '点击主题一键应用；点 ⤓ 下载对应 ZIP 图片包。',
  defaultBadge: '默认',
  stateDefault: '默认',
  ...
  import: '导入',
  importFailed: '导入失败',
  packHintTitle: 'AI 生成提示词',
  packHint: '复制提示词给 AI，生成 PNG + manifest.json 后打包成 ZIP 导入。',
  packCopy: '复制提示词',
  packCopied: '已复制',
...
export const en: Record<string, string> = {
  ...
  themeHint: 'Click a theme to apply it; click ⤓ to download the matching ZIP image pack.',
  ...
  packHintTitle: 'AI generation prompt',
  packHint: 'Copy the prompt to an AI, generate PNGs + manifest.json, pack into a ZIP and import.',
  packCopy: 'Copy prompt',
  packCopied: 'Copied',
